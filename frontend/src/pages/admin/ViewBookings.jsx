          ...
          <tbody>
            {filteredBookings.length > 0 ? (
              filteredBookings.map((booking) => (
                <tr key={booking._id} className="hover:bg-yellow-50 text-center">
                  <td className="px-4 py-4 border text-gray-700">{booking.id}</td>
                  <td className="px-4 py-4 border text-gray-700">{new Date(booking.createdDateTime).toLocaleString()}</td>
                  ...
                  <td className="px-4 py-4 border text-gray-700 font-semibold">
              ...
              <tr>
                <td colSpan="8" className="px-6 py-3 text-center text-yellow-700 font-bold">
