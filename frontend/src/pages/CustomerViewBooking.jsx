...
//         // Filter bookings to show only those associated with the logged-in customer
//         const userBookings = data.filter((booking) => booking.customerId === user.id);

//         // Sort bookings by createdDateTime in descending order (latest first)
//         const sortedBookings = userBookings.sort((a, b) => new Date(b.createdDateTime) - new Date(a.createdDateTime));
...
//     if (user) {
//       fetchBookings();  // Fetch bookings only if the user is logged in
//     }
...
//   return (
//     <div className="container mx-auto p-6 min-h-screen mt-20">
//       <h1 className="text-4xl font-semibold mb-8 text-center text-yellow-700">Your Bookings</h1>
...
//           filteredBookings.map((booking) => (
//             <div key={booking._id} className="bg-white shadow-lg rounded-lg p-10 hover:shadow-xl transition-shadow duration-300">
//               <h3 className="text-xl font-semibold text-yellow-700 mb-3">ID: {booking.id}</h3>
//               <div className="space-y-2">
//                 <p className="text-gray-600">
//                   <strong>Booked Date:</strong> {new Date(booking.createdDateTime).toLocaleString()}
//                 </p>
